...
<div class="row">
            <div class="col-lg-12" style="margin-top: 100px;">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="position-center">
                                @foreach ($edit_product_profile as $key =>$pro )
                                <form style="margin-left:20px;"class="" role="" action="{{URL::to('/update-product-profile/'.$pro->product_id)}}" method="post" enctype="multipart/form-data">
                                    {{ csrf_field() }}
                                    <table>
              <td style="width:300px;margin-top:-30px;">  
                ...
                <div class="group anim" style="--delay: .1s">      
                    <input type="text" required name="product_name" value={{$pro->product_name}}>
                  ...
                  <div class="group anim" style="--delay: .2s">      
                    <input type="text" required name="product_time" value={{$pro->product_time}}>
                    <span class="highlight"></span>
                    <span class="bar"></span>
                    <label>Time</label>
                  </div>
                  ...
                  <div class="group anim" style="--delay: .3s">      
                    <input type="file" required name="product_video"value={{$pro->product_video}}>
                    <span class="highlight"></span>
                    <span class="bar"></span>
                    <label>Video</label>
                  </div>
           ...
           <button class="buttn anim"style="--delay: .5s" >Update</button>
        </div> 
        </td>
           <td style="padding-bottom:100px;" >
           <div class="anim" style="--delay: .2s">
            <textarea name="product_content" id=""  class="card content" cols="30" rows="10" style=" width:225%; font-size:15px;" >{{$pro->product_content}}</textarea>
       </td>
